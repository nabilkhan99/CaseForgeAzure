...
class SessionRepository:
    ...
    def save_trend(self, candidate_id: str, payload: Dict[str, Any]) -> None:
        ...
        # One live report per candidate (trend_reports_candidate_unique, from
        # 0005; 0006 recreates it where absent): a rebuild replaces the old row
        # instead of accumulating history, and two concurrent rebuilds converge
        # on it rather than duplicating.
