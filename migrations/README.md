...
5. `0006_trend_reports_v2.sql`              (trend contract v2: patterns + version,
   the "steady" trajectory value, and the unique candidate_id index that
   `save_trend`'s upsert has always assumed)
